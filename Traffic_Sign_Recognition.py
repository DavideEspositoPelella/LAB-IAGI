# -*- coding: utf-8 -*-
"""Tesi_Traffic_Sign_Recognition.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/18qqV80ICm-Gqigt9uKY8BcAKWVGOB_P-
...
for i, cls_index in enumerate(class_indices):
  ...
  print(f'{class_name}: {len(image_paths)}') #stampa numero samples della classe
  ...
  for ds, images in dataset_data:
    for img_path in images:
      shutil.copy(img_path, f'{DATA_DIR}/{ds}/{class_name}/')   # Copia la source sx nella destination dx
...
"""Creo dataset PyTorch per ogni "image dataset folder" e "data loaders" per semplificare training
...
def train_model(model,net, data_loaders, dataset_sizes, device, n_epochs=10):
  ...
  history = defaultdict(list)   #Con keyerror restituisce valore default list
  best_accuracy = 0
  ...
  for epoch in range(n_epochs):
    ...
    if val_acc > best_accuracy:
      #Salvataggio
      #torch.save(model.state_dict(), 'drive/MyDrive/Modelli/resnet18/resnet18_no.pth')
...
#img_path = 'drive/MyDrive/inference/20220711_113341.jpg'   #doppia curva pericolosa
